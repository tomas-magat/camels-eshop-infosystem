    ...
    def loadfile(self):
        for i in range(5):
            ItemPriceCard(self, self.ui.verticalLayout_25, "test" +
                     str(i), "Test "+str(i), "0000", (5.99, 6.59),os.path.join(PATH,"assets","images","tricko.jpg"))
...
class ItemPriceCard(QtWidgets.QFrame):
    ...
    #     self.label_3 = QtWidgets.QLabel('NAZOV PRODUKTU')
    ...
    def draw_ui(self):
        ...
        self.widget_4.setMinimumSize(QtCore.QSize(60, 0))
        self.widget_4.setMaximumSize(QtCore.QSize(60, 16777215))
        self.widget_4.setObjectName(self.name+"MainLayout")
        self.label_2 = QtWidgets.QLabel("PREDAJNA CENA")
       ...
       # self.verticalLayout_25.addWidget(self)